...
def parse_args():
    ...
    parser.add_argument("-little", dest="little", default=None, type=str, required=True,
                        help="An Illumina methylation27 microarray file for preprocessing.")
    parser.add_argument("-big", dest="big", default=None, type=str, required=True,
                        help="An Illumina methylation27 microarray file for preprocessing.")
...
def process_methylation(df):
    ...
    raise NotImplementedError("Methylation processing is a work in progresss. Thanks for being patient!")
    exit(0)
...
if __name__ == "__main__":
    args = parse_args()
    dat27 = filename_to_df(args.little)
    dat450 = filename_to_df(args.big)
